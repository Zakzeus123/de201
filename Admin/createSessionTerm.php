...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Cette session et ce terme existent déjà!</div>";
    }
    else{
...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="sessionName" value="<?php echo $row['sessionName'];?>" id="exampleInputFirstName" placeholder="Session">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--Sélectionner le terme--</option>';
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Toutes les sessions et termes</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Note: <i>Cliquez sur le symbole de la coche à côté de chaque pour activer la session et le terme!</i></h6>
                </div>
                  ...
                  <?php
                      ...
                      { 
                        while ($rows = $rs->fetch_assoc())
                          {
                            if($rows['isActive'] == '1'){$status = "Actif";}else{$status = "Inactif";}
  ...
  <script>
    $(document).ready(function () {
      $('#dataTable').DataTable(); // ID du tableau
      $('#dataTableHover').DataTable(); // ID du tableau avec survol
    });
  </script>
</body>
