...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Cette classe existe déjà!</div>";
    }
    else{
...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Nom de la classe<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="className" value="<?php echo $row['className'];?>" id="exampleInputFirstName" placeholder="Nom de la classe">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Toutes les classes</h6>
                </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#dataTableHover').DataTable(); // ID From dataTable avec hover
    });
  </script>
</body>
