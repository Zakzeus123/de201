                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <h5 align="center">SYSTÈME DE PRÉSENCE DES ÉTUDIANTS</h5>
                                    ...
                                    <form class="user" method="Post" action="">
                                        <div class="form-group">
                                            <select required name="userType" class="form-control mb-3">
                                                <option value="">--Sélectionner le rôle utilisateur--</option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" required name="username" id="exampleInputEmail" placeholder="Entrez l'adresse e-mail">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-success btn-block" value="Connexion" name="login" />
                                        </div>
                                    </form>
