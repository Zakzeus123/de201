...
if (isset($_POST['view'])) {
  ...
  $query = "SELECT tblattendance.Id, tblattendance.status1, tblattendance.status2, tblattendance.status3, tblattendance.dateTimeTaken, tblclass.className,
            ...
            INNER JOIN tblstudents ON tblstudents.emailAddress = tblattendance.emailAddress
